...
class GraphBasedSummaryOld:
    """
    DEPRECATED! Changed to faster and more reliable Gensim implementation. Only advantage with this is that
    we can more easily measure LexRank-rankings -> with Gensim rankings are hidden behind method signature.
    """
